...
namespace database_blocks {
    ...
    void wal_manager::write_to_wal(const fs::path &log_file_path, const std::string &data) {
    ...
    void wal_manager::read_from_wal(const fs::path &log_file_path) {
        ...
        size_t length = 0;
        while (read_file.read(reinterpret_cast<char *>(&length), sizeof(size_t))) {
